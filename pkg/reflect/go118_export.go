...
func init() {
	gossa.RegisterPackage(&gossa.Package{
		...
		NamedTypes: map[string]gossa.NamedType{
			...
			"MapIter":      {reflect.TypeOf((*q.MapIter)(nil)).Elem(), "", "Key,Next,Reset,Value"},
			"Method":       {reflect.TypeOf((*q.Method)(nil)).Elem(), "IsExported", ""},
