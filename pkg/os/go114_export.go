...
func init() {
	igop.RegisterPackage(&igop.Package{
		...
		NamedTypes: map[string]igop.NamedType{
			"File":         {reflect.TypeOf((*q.File)(nil)).Elem(), "", "Chdir,Chmod,Chown,Close,Fd,Name,Read,ReadAt,Readdir,Readdirnames,Seek,SetDeadline,SetReadDeadline,SetWriteDeadline,Stat,Sync,SyscallConn,Truncate,Write,WriteAt,WriteString,checkValid,chmod,pread,pwrite,read,readdir,readdirnames,seek,seekInvalidate,setDeadline,setReadDeadline,setWriteDeadline,wrapErr,write"},
