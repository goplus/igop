...
func init() {
	gossa.RegisterPackage(&gossa.Package{
		...
		NamedTypes: map[string]gossa.NamedType{
			...
			"Package": {reflect.TypeOf((*q.Package)(nil)).Elem(), "", "Filter,HTML,Markdown,Parser,Printer,Synopsis,Text,collectFuncs,collectTypes,collectValues,lookupPackage,lookupSym"},
