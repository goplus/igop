...
func init() {
	gossa.RegisterPackage(&gossa.Package{
		...
		TypedConsts: map[string]gossa.TypedConst{
			"Bad":                        {reflect.TypeOf(q.Bad), constant.MakeInt64(0)},
			"Con":                        {reflect.TypeOf(q.Con), constant.MakeInt64(2)},
			"FilterFuncDuplicates":       {reflect.TypeOf(q.FilterFuncDuplicates), constant.MakeInt64(1)},
			"FilterImportDuplicates":     {reflect.TypeOf(q.FilterImportDuplicates), constant.MakeInt64(4)},
			"FilterUnassociatedComments": {reflect.TypeOf(q.FilterUnassociatedComments), constant.MakeInt64(2)},
			"Fun":                        {reflect.TypeOf(q.Fun), constant.MakeInt64(5)},
			"Lbl":                        {reflect.TypeOf(q.Lbl), constant.MakeInt64(6)},
			"Pkg":                        {reflect.TypeOf(q.Pkg), constant.MakeInt64(1)},
			"RECV":                       {reflect.TypeOf(q.RECV), constant.MakeInt64(2)},
			"SEND":                       {reflect.TypeOf(q.SEND), constant.MakeInt64(1)},
			"Typ":                        {reflect.TypeOf(q.Typ), constant.MakeInt64(3)},
			"Var":                        {reflect.TypeOf(q.Var), constant.MakeInt64(4)},
		},
