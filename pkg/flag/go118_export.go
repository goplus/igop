...
func init() {
	gossa.RegisterPackage(&gossa.Package{
		...
		NamedTypes: map[string]gossa.NamedType{
			...
			"FlagSet":       {reflect.TypeOf((*q.FlagSet)(nil)).Elem(), "", "Arg,Args,Bool,BoolVar,Duration,DurationVar,ErrorHandling,Float64,Float64Var,Func,Init,Int,Int64,Int64Var,IntVar,Lookup,NArg,NFlag,Name,Output,Parse,Parsed,PrintDefaults,Set,SetOutput,String,StringVar,TextVar,Uint,Uint64,Uint64Var,UintVar,Var,Visit,VisitAll,defaultUsage,failf,parseOne,sprintf,usage"},
		},
