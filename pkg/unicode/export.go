...
func init() {
	gossa.RegisterPackage(&gossa.Package{
		...
		UntypedConsts: map[string]gossa.UntypedConst{
			"LowerCase":       {"untyped int", constant.MakeInt64(1)},
			"MaxASCII":        {"untyped rune", constant.MakeInt64(127)},
			"MaxCase":         {"untyped int", constant.MakeInt64(3)},
			"MaxLatin1":       {"untyped rune", constant.MakeInt64(255)},
			"MaxRune":         {"untyped rune", constant.MakeInt64(1114111)},
			"ReplacementChar": {"untyped rune", constant.MakeInt64(65533)},
			"TitleCase":       {"untyped int", constant.MakeInt64(2)},
			"UpperCase":       {"untyped int", constant.MakeInt64(0)},
			"UpperLower":      {"untyped rune", constant.MakeInt64(1114112)},
			"Version":         {"untyped string", constant.MakeString("13.0.0")},
		},
	})
}
