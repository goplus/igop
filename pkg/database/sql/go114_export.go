...
func init() {
	igop.RegisterPackage(&igop.Package{
		...
		NamedTypes: map[string]igop.NamedType{
			...
			"DB":             {reflect.TypeOf((*q.DB)(nil)).Elem(), "", "Begin,BeginTx,Close,Conn,Driver,Exec,ExecContext,Ping,PingContext,Prepare,PrepareContext,Query,QueryContext,QueryRow,QueryRowContext,SetConnMaxLifetime,SetMaxIdleConns,SetMaxOpenConns,Stats,addDep,addDepLocked,begin,beginDC,conn,connectionCleaner,connectionOpener,exec,execDC,maxIdleConnsLocked,maybeOpenNewConnections,nextRequestKeyLocked,noteUnusedDriverStatement,openNewConnection,pingDC,prepare,prepareDC,putConn,putConnDBLocked,query,queryDC,removeDep,removeDepLocked,startCleanerLocked"},
			...
			"Row":            {reflect.TypeOf((*q.Row)(nil)).Elem(), "", "Scan"},
			...
			"Tx":             {reflect.TypeOf((*q.Tx)(nil)).Elem(), "", "Commit,Exec,ExecContext,Prepare,PrepareContext,Query,QueryContext,QueryRow,QueryRowContext,Rollback,Stmt,StmtContext,awaitDone,closeLocked,closePrepared,closemuRUnlockRelease,grabConn,isDone,rollback,txCtx"},
