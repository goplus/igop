...
func init() {
	gossa.RegisterPackage(&gossa.Package{
		...
		NamedTypes: map[string]gossa.NamedType{
			...
			"UDPConn":             {reflect.TypeOf((*q.UDPConn)(nil)).Elem(), "", "ReadFrom,ReadFromUDP,ReadMsgUDP,SyscallConn,WriteMsgUDP,WriteTo,WriteToUDP,readFrom,readFromUDP,readMsg,writeMsg,writeTo"},
