...
func init() {
	igop.RegisterPackage(&igop.Package{
		...
		NamedTypes: map[string]igop.NamedType{
			...
			"IP":                  {reflect.TypeOf((*q.IP)(nil)).Elem(), "DefaultMask,Equal,IsGlobalUnicast,IsInterfaceLocalMulticast,IsLinkLocalMulticast,IsLinkLocalUnicast,IsLoopback,IsMulticast,IsPrivate,IsUnspecified,MarshalText,Mask,String,To16,To4,matchAddrFamily", "UnmarshalText"},
			...
			"UDPAddr":             {reflect.TypeOf((*q.UDPAddr)(nil)).Elem(), "", "AddrPort,Network,String,family,isWildcard,opAddr,sockaddr,toLocal"},
			"UDPConn":             {reflect.TypeOf((*q.UDPConn)(nil)).Elem(), "", "ReadFrom,ReadFromUDP,ReadFromUDPAddrPort,ReadMsgUDP,ReadMsgUDPAddrPort,SyscallConn,WriteMsgUDP,WriteMsgUDPAddrPort,WriteTo,WriteToUDP,WriteToUDPAddrPort,readFrom,readFromAddrPort,readFromUDP,readMsg,writeMsg,writeMsgAddrPort,writeTo,writeToAddrPort"},
