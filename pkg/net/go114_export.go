...
func init() {
	igop.RegisterPackage(&igop.Package{
		...
		NamedTypes: map[string]igop.NamedType{
			...
			"Resolver":            {reflect.TypeOf((*q.Resolver)(nil)).Elem(), "", "LookupAddr,LookupCNAME,LookupHost,LookupIPAddr,LookupMX,LookupNS,LookupPort,LookupSRV,LookupTXT,dial,exchange,getLookupGroup,goLookupCNAME,goLookupHost,goLookupHostOrder,goLookupIP,goLookupIPCNAMEOrder,goLookupPTR,internetAddrList,lookup,lookupAddr,lookupCNAME,lookupHost,lookupIP,lookupIPAddr,lookupMX,lookupNS,lookupPort,lookupSRV,lookupTXT,preferGo,resolveAddrList,strictErrors,tryOneName"},
