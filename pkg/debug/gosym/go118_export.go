...
func init() {
	igop.RegisterPackage(&igop.Package{
		...
		NamedTypes: map[string]igop.NamedType{
			...
			"LineTable":        {reflect.TypeOf((*q.LineTable)(nil)).Elem(), "", "LineToPC,PCToLine,findFileLine,findFunc,funcData,funcName,funcTab,functabFieldSize,go12Funcs,go12LineToPC,go12MapFiles,go12PCToFile,go12PCToLine,initFileMap,isGo12,parse,parsePclnTab,pcvalue,readvarint,slice,step,string,stringFrom,uintptr"},
			"Obj":              {reflect.TypeOf((*q.Obj)(nil)).Elem(), "", "alineFromLine,lineFromAline"},
			"Sym":              {reflect.TypeOf((*q.Sym)(nil)).Elem(), "", "BaseName,PackageName,ReceiverName,Static,nameWithoutInst"},
