...
func init() {
	igop.RegisterPackage(&igop.Package{
		...
		NamedTypes: map[string]igop.NamedType{
			...
			"Data":            {reflect.TypeOf((*q.Data)(nil)).Elem(), "", "AddSection,AddTypes,LineReader,Ranges,Reader,Type,offsetToUnit,parseAbbrev,parseTypes,parseUnits,readType,sigToType"},
			...
			"Reader":          {reflect.TypeOf((*q.Reader)(nil)).Elem(), "", "AddressSize,ByteOrder,Next,Seek,SeekPC,SkipChildren,clone,maybeNextUnit,offset"},
